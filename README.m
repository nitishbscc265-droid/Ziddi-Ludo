...
<head>
    ...
    <style>
        ...
        .star::after { content: '★'; position: absolute; left: 25%; top: 5%; color: #555; font-size: 20px; }
...
<body>
    ...
    <h2 style="margin: 10px; color: var(--yellow);">🏆 LUDO CHAMPION PRO 🏆</h2>
    ...
    <div class="ui-panel">
        ...
        <div class="dice" id="dice-ui" onclick="handleRoll()">🎲</div>
...
<script>
    ...
    function showLeaderboard() {
        ...
        document.getElementById('leaderboard').innerHTML = `
            <div class="rank-item" style="background:gold; color:black">🥇 1st: ${winners[0].toUpperCase()}</div>
            <div class="rank-item" style="background:silver; color:black">🥈 2nd: ${winners[1].toUpperCase()}</div>
            <div class="rank-item" style="background:#cd7f32; color:white">🥉 3rd: ${winners[2].toUpperCase()}</div>
            <p style="color:red">💀 Failed: ${loser.toUpperCase()}</p>
        `;
